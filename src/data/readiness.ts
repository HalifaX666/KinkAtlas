...
const seeds: ScenarioSeed[] = [
  ['c-ongoing-1','ongoingConsent','You agreed on a scene beforehand. Your partner becomes unusually quiet but has not used a safeword.','Pause or slow down and check in; the change may matter.','Use what you know about their usual responses, but check in if anything feels unclear.','Continue because the original agreement is enough.','prior-negotiation'],
  ...
  ['c-neg-2','negotiation','A dynamic includes the phrase “you decide.” What does that cover?','Agree on which decisions it covers, when it applies, and how either person can change it.','Start with small decisions and discuss the scope when something important comes up.','Treat it as broad authority unless someone names an exception.','authority-scope'],
  ...
  ['c-comm-2','communication','Indirect questions keep leading to unclear answers.','Ask specific, neutral questions and make it easy to correct you.','Ask the same question later when the mood is different.','Use the meaning that best fits the plan.','communication-space'],
  ...
  ['c-bound-2','boundaries','A partner’s limit seems based on information you think is wrong.','Respect it now. Offer information only if they want it, without tying it to agreement.','Explain your view once, then ask them to reconsider later.','Correct the misunderstanding before accepting the limit.','limits-as-challenge'],
  ...
  ['c-power-1','powerAwareness','A well-known community member asks a newcomer for a quick answer.','Notice the pressure and give them real time and space to decide freely.','Ask whether they feel pressured before accepting the answer.','Assume adults are equally able to say no, regardless of status.','power-blindness'],
  ...
  ['c-stop-1','stopSignals','A safeword exists, but someone freezes and stops responding normally.','Stop and check that they are okay; a safeword is not the only signal.','Reduce intensity and ask a yes/no question before continuing.','Wait for the safeword because that was the agreed system.','safeword-only'],
  ...
  ['c-uncertain-1','uncertainty','Someone answers a check-in positively, but their answer does not feel clear.','Pause and ask for clearer information instead of treating continuation as the default.','Ask the same question once more and continue if the answer stays positive.','Take the words literally and avoid second-guessing them.','uncertainty'],
  ...
  ['c-risk-2','riskAwareness','You plan to try a familiar activity with a new person.','Talk it through again for this person; bodies, communication, and risks differ.','Use the familiar approach, with more frequent check-ins.','Treat past success as proof that the activity is low risk.','familiarity'],
  ['c-account-1','accountability','After a scene, someone says an agreed limit was crossed. You remember it differently.','Focus first on their wellbeing and the impact. Listen, note what you agree on, and discuss repair.','Explain what you remember while also apologizing for the impact.','Defend your intent because the limit was not crossed on purpose.','defensiveness'],
  ...
  ['c-after-1','aftercare','Partners want different kinds of contact after an intense experience.','Agree on a plan that respects what each person can offer, with alternatives or later follow-up.','Prioritize the person who received the most intense activity.','Use the same aftercare routine each time for predictability.','aftercare-assumption'],
  ...
  ['c-substance-1','substances','Someone unexpectedly uses a substance before a planned scene.','Check whether everyone can still make clear choices. Postpone if there is meaningful doubt.','Reduce intensity and add check-ins if both still say yes.','Continue because the negotiation happened while sober.','substance-capacity'],
  ...
  ['c-learn-1','learningMindset','A friend has done an activity for years and offers to teach it.','Value their experience while still considering their skill, the risks, and other ways to learn.','Trust them with the basics and seek more education for advanced practice.','Treat years of experience as enough proof that they can teach it.','knowledge-limits'],
]
