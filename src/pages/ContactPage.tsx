  ...
  return (
    <div className="page-width article-page contact-page">
      ...
      <section aria-labelledby="contact-topics-heading">
        <h2 id="contact-topics-heading" className="sr-only">
          Ways to contact KinkAtlas
        </h2>
      ...
      <section className="contact-form-section" aria-labelledby="contact-form-heading">
        <div>
          ...
          <br />
          <p>You can also reach us by email at contact@kinkatlas.com instead of using this form.</p>
          <br />
          <p>For inquiries not related to the above topics, or if you have a personal question to the developer please email them at defiant@kinkatlas.com</p>
        </div>
        <form className="contact-form" name="contact" method="POST" data-netlify="true" netlify-honeypot="website" aria-labelledby="contact-form-heading" onSubmit={handleSubmit}>
          ...
          <div className="contact-field">
            ...
            <select id="contact-topic" name="topic" required value={topic} onChange={(event) => setTopic(event.target.value)} disabled={isSubmitting}>
              ...
              {CONTACT_TOPICS.map((contactTopic) => (
                <option key={contactTopic} value={contactTopic}>
                  {contactTopic}
                </option>
              ))}
            </select>
          ...
          <p className="contact-status" data-status={statusKind} aria-live="polite">
            {status}
          </p>
        </form>
      </section>
